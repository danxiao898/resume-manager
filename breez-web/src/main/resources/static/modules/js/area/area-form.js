...
function loadAreaTree() {
    ...
    var menuStetting = {
        ...
        callback: {
            onClick: function (event, treeId, treeNode) {
                ...
                //将选择的节点放到父资源处
                parentArea(treeNode.id,treeNode.name);
    ...
    //查询所有的权限资源
    $.post(contextPath + "area/list", function (data) {
        var permissionTree = $.fn.zTree.init($("#areaTree"), menuStetting, data.data);
...
function parentArea(parentId,parentName) {
...
function disableUrl() {
    ...
    var ele = document.getElementById("httpUrl");
    ele.setAttribute("readonly","true");
    ele.setAttribute("placeholder","市级区域不填写该项");
}
...
function enableUrl() {
    ...
    ele.setAttribute("placeholder","请输入接口地址")
}