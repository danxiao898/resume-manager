...
$(function () {
    ...
    var options = {
        ...
        columns: [
            ...
            {title: '描述', field: 'des', width:700},
            {title: 'A', field: 'optionA'},
            {title: 'B', field: 'optionB'},
            {title: 'C', field: 'optionC'},
            {title: 'D', field: 'optionD'},
            {title: '答案', field: 'answer'},
            {title: '问题类别', field: 'questionType.name'},
...
function searchForm() {
    ...
    var query = {
        ...
        current: 1,
        des: $("#des").val().trim(),
        questionTypeName: $("#questionTypeName").val().trim(),
    }
