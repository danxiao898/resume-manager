    ...
    $.extend({
        ...
        pageTable: function(options) {
            ...
            $table.bootstrapTable({
                ...
                cardView:options.cardView == null ? false : options.cardView,          //是否显示详细视图
        ...
        deleteResumeInfo: function (url) {
            layer.confirm('确定删除该信息吗？', {
                ...
                //发送请求
                $.submitResumeInfo(url, 'post', {'_method': 'delete'}, 'json');

            })
        },

        submitResumeInfo: function (url, type, data, dataType) {
            //发送请求
            $.ajax({
                url: url,
                type: type,//此处仍然使用post
        ...
        deleteCollect: function (url) {
            layer.confirm('确定删除该信息吗？', {
                ...
                //发送请求
                $.submitCollect(url, 'post', {'_method': 'delete'}, 'json');

            })
        },

        submitCollect: function (url, type, data, dataType) {
            //发送请求
            $.ajax({
                url: url,
                type: type,//此处仍然使用post
