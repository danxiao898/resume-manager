...
import com.breez.security.authentication.CustomAuthenticationSuccessHandler;
...
public class MobileAuthenticationConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        /**
         * 获取容器中已经存在的AuthenticationManager对象，并传入里面
         */
        ...
        /**
         * 构建MobileAuthenticationProvider实例，接收mobileUserDetailsService通过手机号查询用户信息
         */
